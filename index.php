...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/boostrap/css/bootstrap.css">
		...
		<nav>
			...
			<img class="deco img-responsive" src="images/logo.png">
				<ul class="deco2">
					...
					<li class="deco2">
						<a href="#left" class="js-scrollTo">ABOUT</a>
					</li>
				</ul>
			<section>
				...
				<input type="submit" name="submit2" value="REGISTER NOW">
			</section>
			</div>
		</nav>
	</header>
...
<div class="container">
<div class="container-fluid">
	<div class="row img1 div1">
			<div class="offset-2"></div>
			<div class="col-md-2 col1"><img src="images/calendar.png"><br><br>2015<br>June 25</div>
			<div class="col-md-2 col1"><img src="images/location.png"><br><br>California<br>USA</div>
			<div class="col-md-2 col1"><img src="images/tickets.png"><br><br>150<br>Tickets</div>
			<div class="col-md-2 col1"><img src="images/speakers.png"><br><br>06<br>Speakers</div>
	</div>		
...
<div class="container-fluid">
	...
	<div class="row titre2">
		<div class="col-md-4"><img src="images/speaker-1.jpg"><br><br><strong>JOHN SMITH</strong><br>CEO OF PEREN</div>
		<div class="col-md-4"><img src="images/speaker-2.jpg"><br><br><strong>JOHN SMITH</strong><br>CEO OF PEREN</div>
		<div class="col-md-4"><img src="images/speaker-5.jpg"><br><br><strong>JOHN SMITH</strong><br>CEO OF PEREN</div>
	</div>
	</div>
...
<!-- REGISTRATION AND PRICING -->
	...
	<div class="container_fluid">
		...
		<div class="row">
			<div class="col-md-12 titre3">Registration &amp; pricing</div>
		</div>
		<div class="row">
			<div class="col-md-6">
				<input type="text" name="login" value="First Name"/>
			</div>
			<div class="col-md-6">
				<input type="text" name="login" value="Address"/>
			</div>
		</div>
		<br>
		<div class="row">
			<div class="col-md-6">
				<input type="text" name="login" value="Last Name"/>
			</div>
			<div class="col-md-6">
				<input type="text" name="login" value="Zip code"/>
			</div>
		</div>
		<br>
		<div class="row">
		...
		<div class="row">	
			<div class="col-md-6">
				<input type="text" name="login" value="Phone"/></div>
			<div class="col-md-6">
			<select name="choice" id="langues">
		...
		<div class="row">
			<div class="col-md-12">
				<button type="submit" id="buttonNoir">Submit</button>
			</div>
		</div>
	</div>
	</div>
...
<div class="container-fluid">
	<div class="container" id="schedule">
		<div class="row">
			<div class="col-md-12 titre1">EVENT SCHEDULE</div>
		</div>
		</div>
...
<!-- EVENT PARTNER -->
	...
	<div class="container-fluid">
		...
		<div class="container">
				<div class="row">
				<div class="col-md-12 titre1" id="eventpartner">EVENT partner</div></div>
